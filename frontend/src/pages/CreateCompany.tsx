...
export const CreateCompany = () => {
  ...
  return (
    <form onSubmit={onSubmit} className="flex h-full w-full justify-start flex-col overflow-auto max-h-96">
        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name">Nome da empresa</label>
